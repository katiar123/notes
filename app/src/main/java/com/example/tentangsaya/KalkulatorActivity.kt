...
class KalkulatorActivity : AppCompatActivity() {
    ...
    private fun onButtonClick(view: View) {
        when (view.id) {
            ...
            binding.angka2.id -> appendToInput("2", R.raw.click3)
            binding.angka3.id -> appendToInput("3", R.raw.click4)
            binding.angka4.id -> appendToInput("4", R.raw.click5)
            ...
            binding.angka9.id -> appendToInput("9", R.raw.click10)
            ...
            binding.persen.id -> appendToInput("%", R.raw.click16)
            binding.hapus.id -> removeLastCharacter(R.raw.click17)
            binding.hapussemua.id -> clearInput(R.raw.click18)
            binding.samadengan.id -> calculateResult(R.raw.click19)
        }
        updateDisplay()
    }
